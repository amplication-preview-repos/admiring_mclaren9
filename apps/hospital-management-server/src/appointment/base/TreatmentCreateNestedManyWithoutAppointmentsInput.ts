...
@InputType()
class TreatmentCreateNestedManyWithoutAppointmentsInput {
...
export { TreatmentCreateNestedManyWithoutAppointmentsInput as TreatmentCreateNestedManyWithoutAppointmentsInput };
